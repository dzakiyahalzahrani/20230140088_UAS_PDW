...
// Baris $conn->close(); di akhir script ini tidak akan pernah tercapai karena semua jalur eksekusi
// di atasnya berakhir dengan exit(). Dalam kasus script sederhana seperti ini yang tugasnya
// hanya memproses dan langsung redirect/exit, tidak masalah jika dihapus.
// PHP akan otomatis menutup koneksi database ketika skrip selesai dieksekusi.
// $conn->close();
?>